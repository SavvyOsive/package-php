...
1. Press the "Use template" button at the top of this repo to create a new repo with the contents of this package-php
...
[<img src="https://github-ads.s3.eu-central-1.amazonaws.com/package-php.jpg?t=1" width="419px" />](https://spatie.be/github-ad-click/package-php)
...
```php
$package-php = new Savvyosive\PackagePhp();
echo $package-php->echoPhrase('Hello, Savvyosive!');
```
